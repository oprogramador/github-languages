...
## Most popular languages on GitHub as of June 07, 2021, counting only repos with at least 1000 stars
<a name="1000-stars" />
...
## Most popular languages on GitHub as of June 07, 2021, counting only repos with at least 10000 stars
<a name="10000-stars" />
...
## Most popular languages on GitHub as of June 07, 2021, counting only repos with at least 10000 stars and any commits pushed since June 07, 2020
...
|SCSS|[slatedocs/slate](https://github.com/slatedocs/slate) (32673) Beautiful static documentation for your API|[mdbootstrap/mdb-ui-kit](https://github.com/mdbootstrap/mdb-ui-kit) (21005) Bootstrap 5 & Material Design 2.0 UI KIT|[nostalgic-css/NES.css](https://github.com/nostalgic-css/NES.css) (17502) NES-style CSS Framework | ファミコン風CSSフレームワーク|[Hacker0x01/hacker101](https://github.com/Hacker0x01/hacker101) (11977) Source code for Hacker101.com - a free online web and mobile security class.|[jessepollak/card](https://github.com/jessepollak/card) (11291) :credit_card: make your credit card form better in one line of code|[rstacruz/cheatsheets](https://github.com/rstacruz/cheatsheets) (10443) My cheatsheets|[primer/css](https://github.com/primer/css) (10294) The CSS design system that powers GitHub|[microsoft/TypeScript-Node-Starter](https://github.com/microsoft/TypeScript-Node-Starter) (9532) A reference example for TypeScript and Node with a detailed README describing how to use the two together.|[mmistakes/minimal-mistakes](https://github.com/mmistakes/minimal-mistakes) (8083) :triangular_ruler: Jekyll theme for building a personal site, blog, project documentation, or portfolio.|[cobidev/simplefolio](https://github.com/cobidev/simplefolio) (7731) ⚡️ A minimal portfolio template for Developers|
...
|OCaml|[facebook/flow](https://github.com/facebook/flow) (21397) Adds static typing to JavaScript to improve developer productivity and code quality.|[reasonml/reason](https://github.com/reasonml/reason) (9407) Simple, fast & type safe code that leverages the JavaScript & OCaml ecosystems|[facebook/pyre-check](https://github.com/facebook/pyre-check) (5399) Performant type-checking for python.|[rescript-lang/rescript-compiler](https://github.com/rescript-lang/rescript-compiler) (5279) The compiler for ReScript.|[astrada/google-drive-ocamlfuse](https://github.com/astrada/google-drive-ocamlfuse) (4219) FUSE filesystem over Google Drive|[batsh-dev-team/Batsh](https://github.com/batsh-dev-team/Batsh) (4071) A language that compiles to Bash and Windows Batch|[coq/coq](https://github.com/coq/coq) (3352) Coq is a formal proof management system. It provides a formal language to write mathematical definitions, executable algorithms and theorems together with an environment for semi-interactive development of machine-checked proofs. |[ocaml/ocaml](https://github.com/ocaml/ocaml) (3293) The core OCaml system: compilers, runtime system, base libraries|[facebookarchive/pfff](https://github.com/facebookarchive/pfff) (2424) Tools for code analysis, visualizations, or style-preserving source transformation.|[fastpack/fastpack](https://github.com/fastpack/fastpack) (2284) Pack JS code fast & easy|
|Groovy|[gradle/gradle](https://github.com/gradle/gradle) (11923) Adaptable, fast automation for all|[rundeck/rundeck](https://github.com/rundeck/rundeck) (4247) Enable Self-Service Operations: Give specific users access to your existing tools, services, and scripts|[jenkinsci/pipeline-examples](https://github.com/jenkinsci/pipeline-examples) (3677) A collection of examples, tips and tricks and snippets of scripting for the Jenkins Pipeline plugin|[HujiangTechnology/gradle_plugin_android_aspectjx](https://github.com/HujiangTechnology/gradle_plugin_android_aspectjx) (3377) A Android gradle plugin that effects AspectJ on Android project and can hook methods in Kotlin, aar and jar file.|[ben-manes/gradle-versions-plugin](https://github.com/ben-manes/gradle-versions-plugin) (2819) Gradle plugin to discover dependency updates|[johnrengelman/shadow](https://github.com/johnrengelman/shadow) (2505) Gradle plugin to create fat/uber JARs, apply file transforms, and relocate packages for applications and libraries. Gradle version of Maven's Shade plugin.|[Netflix/asgard](https://github.com/Netflix/asgard) (2230) [Asgard is deprecated at Netflix. We use Spinnaker ( www.spinnaker.io ).] Web interface for application deployments and cloud management in Amazon Web Services (AWS). Binary download: http://github.com/Netflix/asgard/releases|[SmartThingsCommunity/SmartThingsPublic](https://github.com/SmartThingsCommunity/SmartThingsPublic) (2058) SmartThings open-source DeviceTypeHandlers and SmartApps code|[novoda/bintray-release](https://github.com/novoda/bintray-release) (1873) A helper for releasing from gradle up to bintray|[kezong/fat-aar-android](https://github.com/kezong/fat-aar-android) (1664) A gradle plugin that merge dependencies into the final aar file works with AGP 3.+|
|Objective-C++|[facebookarchive/pop](https://github.com/facebookarchive/pop) (19848) An extensible iOS and OS X animation library, useful for physics-based interactions.|[textmate/textmate](https://github.com/textmate/textmate) (13590) TextMate is a graphical text editor for macOS 10.12 or later|[facebookarchive/AsyncDisplayKit](https://github.com/facebookarchive/AsyncDisplayKit) (13471) Smooth asynchronous user interfaces for iOS apps.|[TextureGroup/Texture](https://github.com/TextureGroup/Texture) (7128) Smooth asynchronous user interfaces for iOS apps.|[microsoft/WinObjC](https://github.com/microsoft/WinObjC) (6109) Objective-C for Windows|[facebook/componentkit](https://github.com/facebook/componentkit) (5541) A React-inspired view framework for iOS.|[johnboiles/obs-mac-virtualcam](https://github.com/johnboiles/obs-mac-virtualcam) (4085) ARCHIVED! This plugin is officially a part of OBS as of version 26.1. See note below for info on upgrading. 🎉🎉🎉Creates a virtual webcam device from the output of OBS. Especially useful for streaming smooth, composited video into Zoom, Hangouts, Jitsi etc. Like CatxFish/obs-virtualcam but for macOS.|[facebook/FBRetainCycleDetector](https://github.com/facebook/FBRetainCycleDetector) (3907) iOS library to help detecting retain cycles in runtime.|[avibrazil/RDM](https://github.com/avibrazil/RDM) (2937) Easily set Mac Retina display to higher unsupported resolutions|[KhronosGroup/MoltenVK](https://github.com/KhronosGroup/MoltenVK) (2865) MoltenVK is a Vulkan Portability implementation. It layers a subset of the high-performance, industry-standard Vulkan graphics and compute API over Apple's Metal graphics framework, enabling Vulkan applications to run on iOS and macOS.|
|Less|[Tencent/weui](https://github.com/Tencent/weui) (25711) A UI library by WeChat official design team, includes the most useful widgets/modules in mobile web applications.|[Tencent/weui-wxss](https://github.com/Tencent/weui-wxss) (13766) A UI library by WeChat official design team, includes the most useful widgets/modules.|[TalkingData/iview-weapp](https://github.com/TalkingData/iview-weapp) (6023) 一套高质量的微信小程序 UI 组件库|[ng-alain/ng-alain](https://github.com/ng-alain/ng-alain) (4159) NG-ZORRO admin panel front-end framework (surge mirror https://ng-alain-doc.surge.sh)|[zdhxiong/mdui](https://github.com/zdhxiong/mdui) (3220) MDUI 是一个基于 Material Design 的前端框架。|[fossasia/fossasia.org](https://github.com/fossasia/fossasia.org) (1724) FOSSASIA Website https://fossasia.org|[there4/markdown-resume](https://github.com/there4/markdown-resume) (1630) Generate a responsive CSS3 and HTML5 resume with Markdown, with optional PDF output.|[jerrykuku/luci-theme-argon](https://github.com/jerrykuku/luci-theme-argon) (1519) Argon is a clean HTML5 theme for OpenWrt LuCI. Users may setup their own favorite logins, including beautiful pics and customized mp4 videos.|[fossasia/codeheat.org](https://github.com/fossasia/codeheat.org) (1491) Codeheat Coding Contest Website https://codeheat.org|[fossasia/loklak-webtweets](https://github.com/fossasia/loklak-webtweets) (1387) FOSSASIA Tweets with loklak http://fossasia.github.io/loklak-webtweets/|
|Markdown|[tldr-pages/tldr](https://github.com/tldr-pages/tldr) (33069) 📚 Collaborative cheatsheets for console commands|[apple/swift-evolution](https://github.com/apple/swift-evolution) (12385) This maintains proposals for changes and user-visible enhancements to the Swift Programming Language.|[walkccc/CLRS](https://github.com/walkccc/CLRS) (2834) 📚 Solutions to Introduction to Algorithms Third Edition|[KaiserY/trpl-zh-cn](https://github.com/KaiserY/trpl-zh-cn) (2240) Rust 程序设计语言（第二版 & 2018 edition）|[KaiserY/rust-book-chinese](https://github.com/KaiserY/rust-book-chinese) (1324) rust 程序设计语言 中文版|[airbnb/swift](https://github.com/airbnb/swift) (1252) Airbnb's Swift Style Guide.|[nsriram/lambda-the-terraform-way](https://github.com/nsriram/lambda-the-terraform-way) (1080) AWS Lambda using Terraform., an Introductory Cookbook||||
|Blade|[livewire/livewire](https://github.com/livewire/livewire) (11609) A full-stack framework for Laravel that takes the pain out of building dynamic UIs.|[laravel-frontend-presets/tailwindcss](https://github.com/laravel-frontend-presets/tailwindcss) (1075) A Tailwind CSS frontend preset for the Laravel Framework|||||||||
...
|----|----|----|----|----|----|----|
|**TypeScript**|0.72698|11→6|11→5|9→7|7→6|5→5|
|HTML+Django|0.79191|121→72|83→59|63→52|60→51|46→45|
|**Less**|0.80269|104→63|100→72|74→58|46→44|38→36|
|Svelte|0.80616|90→59|80→54|69→54|85→78|🚫→🚫|
|Pug|0.81321|111→69|146→110|91→77|58→49|🚫→🚫|
|EJS|0.82781|71→43|117→88|107→89|99→94|🚫→🚫|
|**SCSS**|0.82932|30→21|45→35|37→31|31→27|25→24|
|Reason|0.83223|170→119|92→68|83→66|82→76|🚫→🚫|
|**Blade**|0.83369|72→45|120→90|100→87|97→92|40→39|
|Twig|0.83462|144→89|142→107|125→108|112→105|🚫→🚫|
|Stylus|0.83826|129→81|138→103|92→79|72→69|🚫→🚫|
|Sass|0.84023|109→67|164→128|115→101|83→77|🚫→🚫|
|Solidity|0.84130|68→42|60→49|67→56|110→103|🚫→🚫|
|Starlark|0.84680|166→112|109→85|89→76|94→87|🚫→🚫|
|**VBA**|0.85199|63→38|114→92|111→102|159→148|🚫→🚫|
|Raku|0.85289|167→113|141→112|151→129|148→139|🚫→🚫|
|Handlebars|0.85380|83→54|119→94|94→85|66→61|🚫→🚫|
|Haml|0.86208|287→211|258→199|172→150|132→123|🚫→🚫|
|SWIG|0.86339|173→117|191→153|135→122|156→146|🚫→🚫|
|Open Policy Agent|0.86376|254→192|217→170|143→121|🚫→🚫|🚫→🚫|
|Slim|0.86483|305→225|261→202|240→211|🚫→🚫|🚫→🚫|
|CodeQL|0.86545|150→103|287→233|202→179|122→115|🚫→🚫|
|Sage|0.86560|279→209|242→188|297→258|🚫→🚫|🚫→🚫|
|Zig|0.86616|178→121|97→78|112→103|165→153|🚫→🚫|
|Vim Snippet|0.86992|191→139|176→146|165→142|161→150|🚫→🚫|
|YAML|0.87314|288→222|220→172|167→148|164→152|🚫→🚫|
|**HTML**|0.87385|5→3|13→11|13→12|13→13|11→11|
|Nix|0.87458|92→70|67→56|66→55|105→99|🚫→🚫|
|NASL|0.87494|318→250|283→221|175→153|🚫→🚫|🚫→🚫|
|Odin|0.87520|312→241|284→222|🚫→🚫|🚫→🚫|🚫→🚫|
|mcfunction|0.87559|154→110|177→149|🚫→🚫|🚫→🚫|🚫→🚫|
|OpenQASM|0.87569|338→274|274→212|214→185|142→132|🚫→🚫|
|Latte|0.87581|320→248|309→248|273→237|🚫→🚫|🚫→🚫|
|VBScript|0.87583|130→90|175→150|164→147|🚫→🚫|🚫→🚫|
|ObjectScript|0.88103|218→169|323→261|🚫→🚫|🚫→🚫|🚫→🚫|
|Futhark|0.88120|342→276|268→211|263→231|🚫→🚫|🚫→🚫|
|ZenScript|0.88165|201→156|197→162|170→149|🚫→🚫|🚫→🚫|
|Macaulay2|0.88175|328→260|343→280|277→240|🚫→🚫|🚫→🚫|
|JSON|0.88326|356→296|280→220|231→200|🚫→🚫|🚫→🚫|
|Dhall|0.88364|230→181|188→156|190→163|124→117|🚫→🚫|
|V|0.88418|212→162|137→114|136→123|113→106|56→55|
|Dafny|0.88812|339→273|339→278|254→224|🚫→🚫|🚫→🚫|
|mIRC Script|0.88987|322→266|282→226|🚫→🚫|🚫→🚫|🚫→🚫|
|**Markdown**|0.89050|241→182|199→159|140→135|68→67|39→37|
|Jsonnet|0.89125|205→159|150→125|103→91|67→66|47→46|
|G-code|0.89146|140→105|128→108|129→120|🚫→🚫|🚫→🚫|
|**Rust**|0.89167|24→23|18→15|18→14|18→16|16→16|
|LFE|0.89171|366→311|310→249|274→239|🚫→🚫|🚫→🚫|
|MLIR|0.89308|357→307|312→253|281→242|🚫→🚫|🚫→🚫|
|HiveQL|0.89391|274→221|321→270|🚫→🚫|🚫→🚫|🚫→🚫|
|wdl|0.89420|229→187|209→174|🚫→🚫|🚫→🚫|🚫→🚫|
|Cirru|0.89450|272→210|229→189|189→178|🚫→🚫|🚫→🚫|
|Nextflow|0.89699|160→125|151→122|213→205|🚫→🚫|🚫→🚫|
|Riot|0.89765|326→261|367→319|235→208|🚫→🚫|🚫→🚫|
|Meson|0.89806|223→180|231→204|210→182|🚫→🚫|🚫→🚫|
|Faust|0.89834|316→267|297→245|🚫→🚫|🚫→🚫|🚫→🚫|
|Marko|0.89977|364→299|360→308|🚫→🚫|🚫→🚫|🚫→🚫|
|YASnippet|0.90258|269→219|243→215|243→214|🚫→🚫|🚫→🚫|
|YARA|0.90458|246→203|140→117|102→92|75→72|🚫→🚫|
|4D|0.90488|278→218|🚫→🚫|🚫→🚫|🚫→🚫|🚫→🚫|
|ABAP|0.90554|134→108|129→113|137→125|🚫→🚫|🚫→🚫|
|DataWeave|0.90564|208→172|340→299|🚫→🚫|🚫→🚫|🚫→🚫|
|GAML|0.90671|283→240|352→304|🚫→🚫|🚫→🚫|🚫→🚫|
|Rich Text Format|0.90690|76→58|84→71|76→72|47→46|🚫→🚫|
|Modula-3|0.90724|321→284|361→309|283→244|🚫→🚫|🚫→🚫|
|Nearley|0.90808|369→318|363→311|🚫→🚫|🚫→🚫|🚫→🚫|
|Modula-2|0.90957|273→242|232→201|282→243|🚫→🚫|🚫→🚫|
|REXX|0.90984|296→259|314→274|296→257|🚫→🚫|🚫→🚫|
|CSON|0.91071|395→349|349→296|🚫→🚫|🚫→🚫|🚫→🚫|
|Org|0.91076|397→355|364→314|286→247|🚫→🚫|🚫→🚫|
|HyPhy|0.91170|325→291|357→306|267→233|🚫→🚫|🚫→🚫|
|reStructuredText|0.91241|386→344|366→318|295→256|152→142|🚫→🚫|
|RobotFramework|0.91383|115→102|194→171|181→157|🚫→🚫|🚫→🚫|
|Pawn|0.91443|147→131|144→127|216→187|🚫→🚫|🚫→🚫|
|Lasso|0.91463|262→237|219→190|272→236|🚫→🚫|🚫→🚫|
|Modelica|0.91502|206→184|152→133|174→152|🚫→🚫|🚫→🚫|
|Asymptote|0.91591|347→305|371→326|🚫→🚫|🚫→🚫|🚫→🚫|
|q|0.91602|226→200|178→160|197→170|🚫→🚫|🚫→🚫|
|MAXScript|0.91645|172→129|192→194|🚫→🚫|🚫→🚫|🚫→🚫|
|Wollok|0.91676|179→151|🚫→🚫|🚫→🚫|🚫→🚫|🚫→🚫|
...
|language|coefficient|all repos|10+ stars|100+ stars|1000+ stars|10000+ stars|
|----|----|----|----|----|----|----|
|Eagle|2.17599|89→277|73→185|90→🚫|126→🚫|🚫→🚫|
|Nginx|1.93582|103→329|108→284|141→🚫|🚫→🚫|🚫→🚫|
|ApacheConf|1.93216|80→293|123→240|113→193|115→🚫|🚫→🚫|
|ActionScript|1.74937|58→135|47→99|50→97|59→81|🚫→🚫|
|GCC Machine Description|1.62442|161→353|184→332|139→🚫|131→🚫|🚫→🚫|
|Protocol Buffer|1.60247|193→361|156→344|144→🚫|146→🚫|🚫→🚫|
|KiCad Layout|1.58178|123→282|103→192|149→🚫|🚫→🚫|🚫→🚫|
|Pure Data|1.56588|176→383|157→345|178→🚫|🚫→🚫|🚫→🚫|
|**Objective-C**|1.48804|19→31|14→22|12→19|10→15|13→15|
|SQLPL|1.44049|91→185|147→255|184→264|154→🚫|🚫→🚫|
|**CoffeeScript**|1.35642|42→83|33→44|30→38|25→32|27→25|
|**Processing**|1.31304|39→51|62→93|73→93|91→135|🚫→🚫|
|ColdFusion|1.30594|66→152|98→126|131→132|🚫→🚫|🚫→🚫|
|Web Ontology Language|1.30198|163→368|204→290|302→🚫|🚫→🚫|🚫→🚫|
|Puppet|1.27542|62→106|75→106|106→140|🚫→🚫|🚫→🚫|
|Objective-J|1.26507|202→228|132→230|162→246|140→131|🚫→🚫|
|ASP|1.24809|46→78|101→143|104→114|61→63|🚫→🚫|
|XML|1.24541|133→188|196→324|224→🚫|162→🚫|🚫→🚫|
|**MATLAB**|1.23929|22→24|27→36|36→44|40→62|🚫→🚫|
|ShaderLab|1.23173|51→46|64→77|56→75|84→144|🚫→🚫|
|OpenEdge ABL|1.22825|122→167|105→130|95→137|141→🚫|🚫→🚫|
|**C++**|1.21619|7→12|5→6|5→5|6→7|7→7|
|**Objective-C++**|1.21581|120→146|78→91|55→69|42→42|34→49|
|ZAP|1.21534|354→316|218→357|168→🚫|🚫→🚫|🚫→🚫|
|AppleScript|1.20598|138→161|90→129|85→107|76→89|🚫→🚫|
|ZIL|1.19317|306→265|210→359|186→🚫|🚫→🚫|🚫→🚫|
|RPC|1.18625|209→341|256→289|219→🚫|🚫→🚫|🚫→🚫|
|IDL|1.18336|151→198|174→219|194→234|135→🚫|🚫→🚫|
|**Clojure**|1.18098|36→53|26→34|24→27|24→24|30→30|
|**Visual Basic .NET**|1.17325|38→50|58→81|72→86|74→71|🚫→🚫|
|LiveScript|1.17055|164→213|124→165|116→116|103→126|🚫→🚫|
|NSIS|1.15472|119→174|153→152|142→155|106→130|🚫→🚫|
|Mask|1.15172|267→406|270→🚫|279→🚫|🚫→🚫|🚫→🚫|
|Graphviz (DOT)|1.15122|265→399|252→🚫|🚫→🚫|🚫→🚫|🚫→🚫|
|Logos|1.14598|102→147|86→102|124→145|🚫→🚫|🚫→🚫|
|M|1.14069|153→175|222→251|209→🚫|136→🚫|🚫→🚫|
|Idris|1.13807|177→195|110→139|120→167|🚫→🚫|🚫→🚫|
|Component Pascal|1.13790|187→243|179→244|203→222|🚫→🚫|🚫→🚫|
|Scheme|1.13464|78→87|61→74|64→73|49→59|🚫→🚫|
|**PHP**|1.13333|8→11|6→7|8→9|9→9|10→10|
|**Java**|1.13333|3→5|4→4|4→4|4→4|4→4|
|Cuda|1.12617|79→82|66→76|59→70|51→64|🚫→🚫|
|ooc|1.12486|280→400|260→341|285→🚫|🚫→🚫|🚫→🚫|
|Bison|1.12434|291→🚫|304→🚫|249→🚫|🚫→🚫|🚫→🚫|
|**Perl**|1.12229|29→41|29→33|33→34|34→35|31→31|
|Ceylon|1.11929|263→351|250→🚫|🚫→🚫|🚫→🚫|🚫→🚫|
|**C**|1.11429|13→13|7→10|7→8|8→8|8→8|
|**Erlang**|1.11359|55→79|38→43|39→39|37→37|🚫→🚫|
|Verilog|1.10727|50→55|51→57|53→59|73→88|🚫→🚫|
|CLIPS|1.09555|183→206|215→329|🚫→🚫|🚫→🚫|🚫→🚫|
|AspectJ|1.08934|221→283|317→🚫|247→🚫|🚫→🚫|🚫→🚫|
|XSLT|1.08351|61→75|68→66|75→74|65→80|🚫→🚫|
|VHDL|1.08125|53→60|72→79|79→83|95→107|🚫→🚫|
|Uno|1.07932|281→347|263→352|300→267|🚫→🚫|🚫→🚫|
|QML|1.07924|82→84|59→63|70→71|107→138|52→52|
|Elm|1.07483|70→74|49→55|48→51|53→60|🚫→🚫|
|VCL|1.07200|233→233|200→239|154→190|160→149|🚫→🚫|
|Terra|1.07134|261→278|237→276|222→265|🚫→🚫|🚫→🚫|
|QMake|1.07019|131→150|241→286|233→253|🚫→🚫|🚫→🚫|
|**Ruby**|1.06970|12→10|10→14|11→13|11→11|15→14|
|Gosu|1.06939|215→288|221→246|205→197|🚫→🚫|🚫→🚫|
|Io|1.06914|175→163|211→336|🚫→🚫|🚫→🚫|🚫→🚫|
|SQL|1.06846|213→226|228→264|221→263|🚫→🚫|🚫→🚫|
|API Blueprint|1.06830|141→186|185→181|244→🚫|🚫→🚫|🚫→🚫|
|**C#**|1.06786|6→9|8→9|10→10|14→10|17→17|
|Diff|1.06708|270→385|331→🚫|🚫→🚫|🚫→🚫|🚫→🚫|
|SaltStack|1.06695|124→149|118→131|145→158|🚫→🚫|🚫→🚫|
|PigLatin|1.06688|188→246|299→🚫|🚫→🚫|🚫→🚫|🚫→🚫|
|PostScript|1.06632|96→111|96→95|88→100|81→85|🚫→🚫|
|**TeX**|1.06394|26→26|30→31|32→32|29→31|23→28|
|Gettext Catalog|1.06390|277→373|354→🚫|265→🚫|🚫→🚫|🚫→🚫|
|Frege|1.06118|285→321|245→303|229→230|130→122|🚫→🚫|
|AutoIt|1.05674|125→141|116→141|105→105|117→110|🚫→🚫|
|Haxe|1.05333|86→96|48→58|62→63|54→50|🚫→🚫|
|**Swift**|1.05333|15→19|16→16|15→15|12→12|12→12|
|SAS|1.05212|95→107|169→173|220→259|🚫→🚫|🚫→🚫|
|Cycript|1.05094|351→337|307→🚫|228→🚫|🚫→🚫|🚫→🚫|
|Mirah|1.05059|345→🚫|311→🚫|280→🚫|🚫→🚫|🚫→🚫|
|CartoCSS|1.04769|249→285|186→206|155→162|119→112|🚫→🚫|
|GLSL|1.04680|87→92|63→69|57→67|70→65|44→43|
